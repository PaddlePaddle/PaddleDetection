...
- 在[train.py](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.1/static/tools/train.py)、[eval.py](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.1/static/tools/eval.py)和[infer.py](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.1/static/tools/infer.py)里创建训练时的Reader：
```python
# 创建DataLoader对象
