...
# python3.7 tools/train.py -c configs/gfl/gfl_r18vd_1x_coco.yml --slim_config configs/slim/distill/gfl_ld_distill.yml
...
python3.7 -m paddle.distributed.launch --gpus 0,1,2,3 tools/train.py -c configs/gfl/gfl_r18vd_1x_coco.yml --slim_config configs/slim/distill/gfl_ld_distill.yml