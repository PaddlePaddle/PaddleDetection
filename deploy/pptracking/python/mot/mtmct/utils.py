...
from .camera_utils import st_filter
...
### no camera 
def get_sim_matrix(cid_tid_dict,cid_tids, use_ff=True, use_rerank=True, use_st_filter=False):
    count = len(cid_tids)
    ...
    if use_st_filter:
        print('use_st_filter => ',use_st_filter)
...
def get_labels(cid_tid_dict, cid_tids, score_thr, use_ff=True, use_rerank=True, use_st_filter=False):
    # 1st cluster
    ...
    sim_matrix = get_sim_matrix(cid_tid_dict, cid_tids, use_ff=use_ff, use_rerank=use_rerank, use_st_filter=use_st_filter)
    ...
    sub_labels = dict()
    sim_matrix = get_sim_matrix(cid_tid_dict_new, cid_tids, use_ff=use_ff, use_rerank=use_rerank, use_st_filter=use_st_filter)
