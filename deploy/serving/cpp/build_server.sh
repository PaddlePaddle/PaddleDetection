...
# cp 自定义OP代码
\cp ../deploy/serving/cpp/preprocess/ppdet_ppyoloe_op.* ${Serving_repo_path}/core/general-server/op
\cp ../deploy/serving/cpp/preprocess/ppdet_yolov3_op.* ${Serving_repo_path}/core/general-server/op
