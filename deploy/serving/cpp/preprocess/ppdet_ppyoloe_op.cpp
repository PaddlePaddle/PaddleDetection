...
#include "core/general-server/op/ppdet_ppyoloe_op.h"
...
void PPDetPPYOLOEOp::preprocess_det(const cv::Mat &img, float *data,
...
cv::Mat PPDetPPYOLOEOp::Base2Mat(std::string &base64_data) {
  cv::Mat img;
  std::string s_mat;
...
std::string PPDetPPYOLOEOp::base64Decode(const char *Data, int DataByte) {
