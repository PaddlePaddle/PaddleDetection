...
#include "core/general-server/op/ppdet_yolov3_op.h"
...
void PPDetYOLOv3Op::preprocess_det(const cv::Mat &img, float *data,
...
cv::Mat PPDetYOLOv3Op::Base2Mat(std::string &base64_data) {
  cv::Mat img;
  std::string s_mat;
...
std::string PPDetYOLOv3Op::base64Decode(const char *Data, int DataByte) {
