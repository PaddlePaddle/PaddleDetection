...
- [Large-scale detection pretrained models](configs/rcnn_enhance/README_en.md): Large-scale practical server-side detection pretrained models with 676 categories are provided for most application scenarios.
