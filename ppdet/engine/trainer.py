...
from ppdet.metrics import Metric, COCOMetric, VOCMetric, WiderFaceMetric, RBoxMetric, JDEDetMetric, SNIPERCOCOMetric, CULaneMetric, Zeroshot_COCOMetric
...
class Trainer(object):
    ...
    def _init_metrics(self, validate=False):
        ...
        if self.cfg.metric == 'COCO' or self.cfg.metric == "SNIPERCOCO" or self.cfg.metric == 'ZeroshotCOCO':
            ...
            elif self.cfg.metric == "ZeroshotCOCO":
                self._metrics = [
                    Zeroshot_COCOMetric(
                        anno_file=anno_file,
                        dataset=dataset,
