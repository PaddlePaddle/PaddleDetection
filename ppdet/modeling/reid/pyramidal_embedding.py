...
class PCB_plus_dropout_pyramid(nn.Layer):
    def __init__(self,
        ...
        self.pyramid_conv_list0, self.pyramid_fc_list0 = self.basic_branch(num_conv_out_channels, input_ch)
        ...
        for idx_branches in range(self.num_branches):
            ...
            fc = nn.Linear(in_features=num_conv_out_channels, 
                    ...
                    weight_attr=ParamAttr(
                        name=name + "_weights",
                        initializer=Normal(mean=0., std=0.001)),
                    bias_attr=ParamAttr(
                        name=name + "_bias", 
    ...
    def pyramid_forward(self, feat):
        ...
        for idx_branches in range(self.num_branches):
            ...
            local_feat = paddle.reshape(local_feat, shape=[local_feat.shape[0], -1])
