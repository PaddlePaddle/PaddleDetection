...
@register_op
class RandomSquareCrop(BaseOperator):
    ...
    def __init__(self,
        ...
        super(RandomSquareCrop, self).__init__()
        ...
        while True:
            ...
            for i in range(250):
                ...
                def is_center_of_bboxes_in_patch(boxes, patch):
                    ...
                    mask = (
                        (center[:, 0] > patch[0]) * (center[:, 1] > patch[1]) *
                ...
                if not mask.any():
                    continue
                #  for key insample['gt_bbox']:
                boxes = sample['gt_bbox'].copy()
                ...
                # labels
                label_key = self.bbox2label.get('gt_bbox')
