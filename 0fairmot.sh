...
config=configs/mot/fairmot/${job_name}.yml
log_dir=log_dir/${job_name}

# 1. training
#CUDA_VISIBLE_DEVICES=6 python3.7 tools/train.py -c ${config}
#python3.7 -m paddle.distributed.launch --log_dir=${log_dir} --gpus 6,7 tools/train.py -c ${config} # &> ${job_name}.log &

# 2. eval
#CUDA_VISIBLE_DEVICES=7 python3.7 tools/eval_mot.py -c ${config} -o weights=https://paddledet.bj.bcebos.com/models/mot/fairmot_dla34_30e_1088x608.pdparams
#CUDA_VISIBLE_DEVICES=0 python3.7 tools/eval_mot.py -c ${config} -o weights=output/${job_name}/model_final.pdparams
...
#CUDA_VISIBLE_DEVICES=7 python3.7 tools/infer_mot.py -c ${config} -o weights=https://paddledet.bj.bcebos.com/models/mot/fairmot_dla34_30e_1088x608.pdparams  --image_dir=dataset/mot/visdrone_mcmot/images/val/uav0000086_00000_v --save_images

# 4.export model
CUDA_VISIBLE_DEVICES=0 python3.7 tools/export_model.py -c ${config} -o weights=https://paddledet.bj.bcebos.com/models/mot/fairmot_dla34_30e_1088x608.pdparams
