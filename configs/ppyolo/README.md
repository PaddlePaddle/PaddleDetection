...
- PP-YOLO模型使用COCO数据集中train2017作为训练集，使用test-dev2017作为测试集，`Box AP`为`mAP(IoU=0.5:0.95)`评估结果。
...
- PP-YOLO tiny模型使用COCO数据集中train2017作为训练集，使用val2017作为测试集，`Box AP`为`mAP(IoU=0.5)`评估结果。
