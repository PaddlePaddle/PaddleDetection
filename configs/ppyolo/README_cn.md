...
[PP-YOLO](https://arxiv.org/abs/2007.12099)是PaddleDetection优化和改进的YOLOv3的模型，其精度(COCO数据集mAP)和推理速度均优于[YOLOv4](https://arxiv.org/abs/2004.10934)模型，要求使用PaddlePaddle 2.0.2(可使用pip安装) 或适当的[release/2.1版本](https://www.paddlepaddle.org.cn/documentation/docs/zh/release/2.1/install/Tables.html#whl-release/2.1)。
