...
|PP-YOLOE+_tiny(320)|   业务数据集   |  49.8  |  -  | [下载链接](https://bj.bcebos.com/v1/paddledet/models/pipeline/mot_ppyoloe_t_60e_pipeline.zip) | [配置文件](./ppyoloe_plus_crn_tiny_60e_pphuman.yml) |
|PP-YOLOE+_tiny(416)|   业务数据集   |  52.2  |  -  | [下载链接](https://bj.bcebos.com/v1/paddledet/models/pipeline/mot_ppyoloe_t_60e_pipeline.zip) | [配置文件](./ppyoloe_plus_crn_tiny_60e_pphuman.yml) |
