...
- 通用目标检测:
  ...
  - [移动端模型](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.4/static/configs/mobile/README.md)
  - [676类目标检测](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.4/static/docs/featured_model/LARGE_SCALE_DET_MODEL.md)
...
- 比赛冠军方案
  - [Objects365 2019 Challenge夺冠模型](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.4/static/docs/featured_model/champion_model/CACascadeRCNN.md)
  - [Open Images 2019-Object Detction比赛最佳单模型](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.4/static/docs/featured_model/champion_model/OIDV5_BASELINE_MODEL.md)
...
- [人像圣诞特效自动生成工具](https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.4/static/application/christmas)
